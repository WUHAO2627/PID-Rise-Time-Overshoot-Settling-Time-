...
## Generated on : Thu Oct 30 08:54:52 2025
## Final product: ./fan_control.exe
...
MODELREF_LINK_RSPFILE     = fan_control_ref.rsp
...
MODELREF_LIBS = C:/Work/RD/Projects/Fan/CodeGeneration/slprj/ert/fan_control/fan_control_rtwlib.lib

LIBS = $(START_DIR)/slprj/ert/fan_control/coderassumptions/lib/fan_control_ca.lib
...
xil_interface.obj : $(START_DIR)/slprj/ert/fan_control/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/slprj/ert/fan_control/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
