...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% - Generated on:   24-Oct-2025 14:05:01
...
switch action
  ...
  case 'CSCDefn'
    ...
    h = Simulink.CSCDefn;
    set(h, 'Name', 'FanControl');
    set(h, 'OwnerPackage', 'fan');
    set(h, 'CSCType', 'Unstructured');
    set(h, 'MemorySection', 'mysection');
  ...
  case 'MemorySectionDefn'
    ...
    set(h, 'Name', 'mysection');
    set(h, 'OwnerPackage', 'fan');
    set(h, 'Comment', '');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '/*#pragma fan_section begin*/');
    set(h, 'PostPragma', '/*#pragma fan_section end*/');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', false);
    set(h, 'IsConst', true);
